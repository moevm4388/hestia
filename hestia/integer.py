...
class Integer:
    ...
    def __init__(self, value: int = None, sign: int = None, natural: NaturalNumber = None) -> None:
        """
...
class IntegerModule(Module):
    ...
    def integer_to_natural(self, z: Integer) -> NaturalNumber:
        ...
        if z.sign == 1:
            raise ValueError("Запрещено преобразовывать отрицательные числа в натуральные")
        return z.natural
